        ...
        <div className="bg-slate-50 border border-slate-100 rounded-[2rem] overflow-hidden shadow-xl grid grid-cols-1 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 p-6 md:p-8 text-slate-900 flex flex-col justify-center relative overflow-hidden bg-white/50">
            <div className="relative z-10 text-center sm:text-left">
              <h2 className="font-display text-3xl md:text-4xl font-bold mb-4 md:mb-6">{t('contact.heading')}</h2>
              <p className="text-slate-600 text-sm md:text-base mb-8 md:mb-10 font-light">{t('contact.sub')}</p>
              ...
              <div className="space-y-6 md:space-y-8">
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <p className="text-[10px] md:text-xs text-slate-500 uppercase tracking-widest font-bold mb-1">{t('contact.callLabel')}</p>
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <p className="text-[10px] md:text-xs text-slate-500 uppercase tracking-widest font-bold mb-1">{t('contact.waLabel')}</p>
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 md:gap-4">
                  ...
                  <div>
                    <p className="text-[10px] md:text-xs text-slate-500 uppercase tracking-widest font-bold mb-1">{t('contact.addressLabel')}</p>
          ...
          <div className="lg:col-span-3 relative h-[300px] sm:h-[400px] lg:h-auto min-h-[300px]">
            ...
            <div className="absolute bottom-4 right-4 md:bottom-6 md:right-6 bg-white p-3 md:p-4 rounded-xl shadow-lg max-w-[200px] md:max-w-xs border border-slate-100 hidden sm:block">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="font-bold text-slate-800 text-xs md:text-sm">{t('contact.infoTitle')}</p>
              </div>
              <p className="text-[10px] md:text-xs text-slate-500">{t('contact.infoText')}</p>
            </div>
          </div>
