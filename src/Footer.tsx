        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 text-center sm:text-left">
          ...
          <div className="flex flex-col items-center sm:items-start">
            ...
            <div className="flex gap-3">
              <a className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-50 flex items-center justify-center hover:bg-primary hover:text-white transition border border-slate-200 text-slate-500 shadow-sm" href="https://facebook.com" target="_blank" rel="noreferrer" aria-label="Facebook">
              ...
              <a className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-50 flex items-center justify-center hover:bg-primary hover:text-white transition border border-slate-200 text-slate-500 shadow-sm" href="https://twitter.com" target="_blank" rel="noreferrer" aria-label="Twitter">
