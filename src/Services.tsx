...
const SERVICES_DATA = [
  ...
  { title: "Chirurgia i Odbudowa", desc: "Skomplikowane ekstrakcje, sterowana regeneracja kości i zabiegi chirurgiczne w komfortowych warunkach.", icon: "medical_services", colorClass: "bg-teal shadow-teal/30", bgClass: "bg-teal-100", textColor: "text-teal" },
